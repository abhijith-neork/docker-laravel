...
@section('content')
    ...
    <!-- Modal  delete-->
    <div class="modal fade role-modal" id="dltModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete data?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-role" id="delete-role" action="{{ route('role.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="role_id" id="dlt_role_id">
