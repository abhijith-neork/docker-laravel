        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="title-head d-flex justify-content-between">
                    <h6 class="mb-0 text-uppercase">POLICIES</h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                        <div class="table-responsive">
                            ...
                            <table id="policy_Table" class="table table-striped table-bordered" style="width:100%">
                                <thead>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete this Policy?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-employee-cat" action="{{ route('policy.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="policy_id" id="dlt_policy_id">
