...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="btm-for mb-4 text-lg-end">
                            <div class="ms-auto">
                                <div class="btn-group">
                                    @if (hasPermission('sub-category.store'))
                                ...
                                <thead>
                                    <tr class="bxs" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                        ...
                                        <th>Action
                                            ...
                                            <a href="{{ route('sub-category.report') }}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete this sub category?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-sub-cat" action="{{ route('sub-category.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="cat_id" id="dlt_sub_cat_id">
    ...
    @include('admin.sub_category.create');
