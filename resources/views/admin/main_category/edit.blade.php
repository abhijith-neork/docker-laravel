    ...
    <div class="offcanvas offcanvas-end customeoff addtask" tabindex="-1" id="MainCatEditForm">
        <div class="offcanvas-header">
            <h5 class="modal-title" id="#gridSystemModal1">Edit Employee Category</h5>
        ...
        <div class="offcanvas-body">
            <div class="container-fluid">
                ...
                <form id="editmaincategory" class="row g-3 needs-validation" novalidate method="post"
                    action="{{ route('employee-category.update') }}" enctype="multipart/form-data">
        ...
        <div class="button-footer">
            <div class="d-md-flex d-flex d-grid align-items-center gap-3 justify-content-end">
                <button type="submit" form="editmaincategory" class="btn  px-4  template-btn ">Update</button>
