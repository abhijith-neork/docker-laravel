...
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="btm-for mb-4 text-lg-end">
                            <div class="ms-auto">
                                <div class="btn-group">
                                    @if (hasPermission('employee-category.store'))
                ...
                <div class="title-head d-flex justify-content-between">
                    <h6 class="mb-0 text-uppercase">EMPLOYEE CATEGORIES</h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                        <div class="table-responsive">
                            ...
                            <table id="main_category_Table" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr class="bxs" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                        ...
                                        <th>Action
                                            ...
                                            <a href="{{ route('employee-category.report') }}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete this Employee category?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-employee-cat" action="{{ route('employee-category.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="cat_id" id="dlt_main_cat_id">
    ...
    @include('admin.main_category.create')
    @include('admin.main_category.edit')
