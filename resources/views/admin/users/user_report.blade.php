            ...
            <div class="row">
                <div class="col-12">
                    <a href="javascript:void(0)" class="home__icon">
                        <i title="Back" onclick="window.location.href='/users';" class="fa fa-arrow-left"></i>
                    </a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                    <div class="table-responsive">
                        ...
                        <table id="user_report_Table" class="table table-striped table-bordered" style="width:100%">
                            <thead>
