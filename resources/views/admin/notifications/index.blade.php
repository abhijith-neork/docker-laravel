        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete this notification?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-employee-cat" action="{{ route('notification.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="notification_id" id="dlt_notification_id">
