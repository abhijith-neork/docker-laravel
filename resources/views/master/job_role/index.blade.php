...
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="btm-for mb-4 text-lg-end">
                            <div class="ms-auto">
                                <div class="btn-group">
                                    @if (hasPermission('job_role.store'))
                ...
                <div class="title-head d-flex justify-content-between">
                    <h6 class="mb-0 text-uppercase">Job Roles</h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                        <div class="table-responsive">
                            ...
                            <table id="job_role_Table" class="table table-striped table-bordered" style="width:100%">
                                <thead>
    ...
    <!-- Modal  delete-->
    <div class="modal fade job_role-modal" id="dltModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete Job Role?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-job_role" id="delete-job_role" action="{{ route('job_role.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="job_role_id" id="dlt_job_role_id">
    ...
    @include('master.job_role.create')
    @include('master.job_role.edit')
