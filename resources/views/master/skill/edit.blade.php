            ...
            <div class="modal-content">
                ...
                <div class="modal-footer text-center">
                    ...
                    <button type="button" class="btn template-btn px-5 confirmYes" data-bs-toggle="offcanvas"
                        href="#skillEditForm" role="button" aria-controls="offcanvasExample1">Yes
                    </button>
    ...
    <div class="offcanvas offcanvas-end customeoff addtask" tabindex="-1" id="skillEditForm">
        <div class="offcanvas-header">
            <h5 class="modal-title" id="#gridSystemModal1">Edit Skill</h5>
        ...
        <div class="offcanvas-body">
            <div class="container-fluid">
                ...
                <form id="skill-edit" class="row g-3 needs-validation" novalidate method="post"
                    action="{{ route('skill.update') }}" enctype="multipart/form-data">
                    <input type="hidden" id="skill_id" name="skill_id">
                    @csrf
                    <div class="col-md-12">
                        <label for="skill_name" class="form-label">Skill Name<span>*</span></label>
                        <input type="text" class="form-control skillName" id="skill_name" placeholder="Skill Name"
                            value="" name="skill_name" required>
        ...
        <div class="button-footer">
            <div class="d-md-flex d-flex d-grid align-items-center gap-3 justify-content-end">
                <button type="submit" form="skill-edit" class="btn  px-4  template-btn ">Update</button>
