...
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="title-head d-flex justify-content-between">
                    <h6 class="mb-0 text-uppercase">Skills</h6>
    ...
    <!-- Modal  delete-->
    <div class="modal fade skill-modal" id="dltModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete Skill?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-skill" id="delete-skill" action="{{ route('skill.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="skill_id" id="dlt_skill_id">
    ...
    @include('master.skill.create')
    @include('master.skill.edit')
