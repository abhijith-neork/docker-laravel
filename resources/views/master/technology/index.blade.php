...
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="btm-for mb-4 text-lg-end">
                            <div class="ms-auto">
                                <div class="btn-group">
                                    @if (hasPermission('technology.store'))
                ...
                <div class="title-head d-flex justify-content-between">
                    <h6 class="mb-0 text-uppercase">Technologies</h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                        <div class="table-responsive">
                            ...
                            <table id="technology_Table" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr class="bxs" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                        ...
                                        <th>Action
                                            ...
                                            <a href="{{route('technology.report')}}">
    ...
    <!-- Modal  delete-->
    <div class="modal fade technology-modal" id="dltModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete Technology?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-technology" id="delete-technology" action="{{ route('technology.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="technology_id" id="dlt_technology_id">
    ...
    @include('master.technology.create')
    @include('master.technology.edit')
