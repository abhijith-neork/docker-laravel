...
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="title-head d-flex justify-content-between">
                    <h6 class="mb-0 text-uppercase">Designations</h6>
                                ...
                                <thead>
                                    <tr class="bxs" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                        ...
                                        <th>Action
                                            ...
                                            <a href="{{route('designation.report')}}">
    ...
    <!-- Modal  delete-->
    <div class="modal fade designation-modal" id="dltModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete Designation?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-designation" id="delete-designation" action="{{ route('designation.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="designation_id" id="dlt_designation_id">
    ...
    @include('master.designation.create')
    @include('master.designation.edit')
