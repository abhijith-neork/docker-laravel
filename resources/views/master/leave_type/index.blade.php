...
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="btm-for mb-4 text-lg-end">
                            <div class="ms-auto">
                                <div class="btn-group">
                                    @if (hasPermission('leave_type.store'))
                ...
                <div class="title-head d-flex justify-content-between">
                    <h6 class="mb-0 text-uppercase">Leave Types</h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                        <div class="table-responsive">
                            ...
                            <table id="leave_type_Table" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr class="bxs" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                        ...
                                        <th>Action
                                            ...
                                            <a href="{{route('leave_type.report')}}">
    ...
    <!-- Modal  delete-->
    <div class="modal fade leave_type-modal" id="dltModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 style="text-align: center;font-size: 22px;"> Do you want to delete Leave Type?
                    </h2>
                </div>
                <div class="modal-footer text-center">
                    <form name="delete-leave_type" id="delete-leave_type" action="{{ route('leave_type.destroy') }}" method="post">
                        @csrf

                        <input type="hidden" name="leave_type_id" id="dlt_leave_type_id">
    ...
    @include('master.leave_type.edit')
