    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="title-head d-flex justify-content-between">
                <h6 class="mb-0 text-uppercase">Leave Type Report</h6>
            ...
            <div class="row">
                <div class="col-12">
                    <a href="javascript:void(0)" class="home__icon">
                        <i title="Back" onclick="window.location.href='/leave_type';" class="fa fa-arrow-left"></i>
                    </a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                    <div class="table-responsive">
                        ...
                        <table id="leave_type_report_Table" class="table table-striped table-bordered" style="width:100%">
                            <thead>
